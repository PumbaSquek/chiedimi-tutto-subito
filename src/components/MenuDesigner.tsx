    ...
    <div className="min-h-screen bg-gradient-warm">
      ...
      <header className="bg-gradient-primary text-primary-foreground p-6 shadow-elegant no-print">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3"><ChefHat className="h-8 w-8"/><h1 className="text-2xl font-bold">Menu Designer</h1></div>
          <div className="flex gap-3">
            <Button variant="gold" onClick={handlePrint}><Download className="h-4 w-4"/>Esporta PDF</Button>
            <Button variant="elegant"><Save className="h-4 w-4"/>Salva Menu</Button>
          </div>
        </div>
      </header>
